...
| Метод                    | Аргументы                 | Возвращаемый тип           | Описание                  |
|--------------------------|---------------------------|----------------------------|---------------------------|
| read_json_file           | ```path``` тип str и Path | List[Dict] список словарей | Функция чтения JSON-файла |
...
| Метод                    | Аргументы                         | Возвращаемый тип                | Описание                                         |
|--------------------------|-----------------------------------|---------------------------------|--------------------------------------------------|
| convert_currency         | ```dict_data``` тип dict: Словарь | float: Число с плавающей точкой
# Тестирование
### Модуль masks
